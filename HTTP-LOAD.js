 ...
 */
 ...
 if (process.argv.length < 5){console.log(`Usage: node HTTP-LOAD.js [URL] [TIME] [REQ_PER_SEC] [THREADS\nExample: node HTTP-LOAD.js https://tls.mrrage.xyz 500 8 30`); process.exit();}
