...
let randomHeaders = headerGenerator.getHeaders();
 ...
 if (cluster.isMaster){
    ...
    console.log('\x1b[38;2;255;0;0m' +  'BYPASSV2| GRUP TELE  https://t.me/freefocket and https://t.me/powerfocket'.bgRed);
    console.log(`----------------------------------------`.gray)
    ...
    console.log(`----------------------------------------`.gray)
     console.log(`Note :  Powerproof https://t.me/powerfocket`.gray)
    setTimeout(() => {
    }, process.argv[5] * 1000);
